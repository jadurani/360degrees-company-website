...
export const COMPLETE_TESTIMONIALS = [
  {
    statement: `On behalf of Synergygroup Operations Inc, We would like to thank you, 360 degrees System Corporation for the outstanding work done for our office. Your professional and practical approach to detail and service has proved to be efficient. You always kept me informed and you were very fair when unexpected issues came up. Your high-quality work and your excellent service gave us the results we expected. It is pricy but it paid off with high integrity, good quality, unique designs, and high value work. We truly appreciate your commitment on this project, you proved to be wonderful at listening to our needs, understanding our priorities and communicating with us about our options. The quality and timeliness of the work was very good, your customer service skills are first-rate. It has been a pleasure to work with you again. We would recommend your company to anyone!`,
    person: {
      name: "Phoebe",
      company: "SynergyGroup Operations Inc.",
    },
  ...
  {
    statement: `360 has been a great vendor for all my previous fit-out projects. From the initial consultation to the final walkthrough, your company demonstrated professionalism, expertise, and teamwork that exceeded my expectations.

    Communication: Throughout the project, your team maintained open and transparent communication. They listened attentively to the concerns, providing regular updates on the progress. This made us feel involved and confident in the project's success.

    Expertise: It was evident that your team possessed a deep understanding of design and construction. They consistently demonstrated craftsmanship and attention to detail, ensuring that every aspect of the project was executed to perfection.

    Teamwork: Your crew worked seamlessly together, showcasing their dedication and synergy. Evidently, they had a strong camaraderie, translating into efficient and practical work. Their ability to collaborate and problem-solve on the spot was truly remarkable.

    Timeliness: The project was completed on time, which was a pleasant surprise given the complexity of the work involved. Your team's commitment to meeting deadlines was greatly appreciated and made a difference in our delivery of projects on time and within budget.

    Cleanliness: Your crew took great care to maintain a tidy work environment.

    Respectful and Friendly: Your team was not only highly skilled but also respectful and friendly. They were approachable and willing to address my questions or concerns throughout the project.
  ...
  {
    statement: `Working with 360 Degrees as our general contractor on our Office Buildout project was a great experience from start to finish. Their expertise in their field, as well as their professionalism and dedication to getting the job done, impressed us very much.
  ...
  },
  {
    ...
    Working with 360 Deg helped us strategize how to double up the original seating capacity from 43 while maintaining employee satisfaction with organized seating arrangements and office ergonomics. The employees love the moveable desk despite the changes from a big working table to a smaller size, half-size from the original. Also, the modified seating arrangement fits the team for collaboration and communication in the office.

    During the construction, the communication with 360 really worked well. They are very cooperative and responsive to all our questions. They have provided the essential needs we requested. Also, they meet the lead time of the turnover based on the agreement despite the minor issues of the outcome.

    Opportunities for improvement to 360 Degree
    I am looking forward to 306 Deg still being cooperative and responsive even if the project has already been turned in, especially if the contract is still under warranty and the project is still within validity.
    The additional constructions should be at a reasonable cost.
  ...
  {
    statement: `I've had the pleasure of working with 360 since 2015 and I can say that it has been one of the most fulfilling and productive partnerships I have ever had in my career.

    Their team was instrumental in the completion of over 10 builds and 10,000's of sqm throughout the Philippines. I've also tapped them multiple times for build consultations in Taiwan, Malaysia, Europe, and North America.

    360 brings a unique blend of creativity, efficiency, excellence of execution, accountability, and consistency that makes working with them a pleasure.

    Above all else, 360 is a true partner. They care deeply about their business but also for their clients. They have the humility to admit when they've made a mistake, the character to fix it, and the courage to confront when they believe there is a better path forward.
